...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/info" method="post" class="form-horizontal"><%--
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="lbl">${user.officeNames}</label>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">职级:</label>
			<div class="controls">
				<label class="lbl">${user.sysrank.name}</label>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:input path="name" htmlEscape="false" maxlength="50" class="required name" readonly="true"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<%-- <label class="lbl">${user.no}</label> --%>
				 <form:input path="no" htmlEscape="false" maxlength="50" class="required no" readonly="true"/>
				<span class="help-inline"><font color="red">*</font> </span> 
			</div>
	    </div>
		...
		<%-- 	<label class="lbl">${user.email}</label> --%>
				 <form:input path="email" htmlEscape="false" maxlength="100" class="required email" readonly="true" />
				<span class="help-inline"><font color="red">*</font> </span> 
			</div>
		</div>
		<div class="control-group">
