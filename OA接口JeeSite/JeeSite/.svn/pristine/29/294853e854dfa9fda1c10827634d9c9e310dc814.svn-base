...
public class OaNotifyMeeting extends DataEntity<OaNotifyMeeting> {
	...
	private OfficeRoom officeRoom;// 会议室
	private String meetReady;// 会议准备
	private User hoster;// 主持人
	...
	public String getMeetReady() {
		return meetReady;
	}

	public void setMeetReady(String meetReady) {
		this.meetReady = meetReady;
	}
