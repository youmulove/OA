...
public class LoginController extends BaseController {
	...
	public String login(HttpServletRequest request,
		...
		return   new  Gson().toJson(new JsonResult<Map<String,Object>>(JsonResult.ERROR,"用户未登陆,请退出后重新登陆",null));
	}
	...
	public String loginFail(HttpServletRequest request,
		...
		if (principal != null) {
			...
			map.put("__sid", request.getSession().getId());
			return   new  Gson().toJson(new JsonResult<Map<String,Object>>(JsonResult.SUCCESS,"获得成功",map));
		}
		...
		if (StringUtils.isBlank(message) || StringUtils.equals(message, "null")) {
			return    new  Gson().toJson(new JsonResult<Map<String,Object>>(JsonResult.ERROR,"用户名或密码错误",null));
		}
		...
		return  new  Gson().toJson(new JsonResult<Map<String,Object>>(JsonResult.ERROR,message,null));
	}
	...
	@ResponseBody
	public JsonResult<Map<String,Object>> index(HttpServletRequest request, HttpServletResponse response) {
		Principal principal = UserUtils.getPrincipal();
		...
		Map<String,Object> map=new HashMap<String,Object>();
		map.put("__sid", request.getSession().getId());
		return new JsonResult<Map<String,Object>>(JsonResult.SUCCESS,"获得成功",map);
	}
