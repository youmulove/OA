...
public class OaApplyOfficeroomService extends
    ...
    public int deleteOaApplyOfficeroomByprocInsId(OaApplyOfficeroom oaApplyOfficeroom){
        return 	OaApplyOfficeroomDao.deleteOaApplyOfficeroomByprocInsId(oaApplyOfficeroom);
    }
    public OaApplyOfficeroom selectOaApplyOfficeroomByprocInsId(OaApplyOfficeroom oaApplyOfficeroom){
    	return OaApplyOfficeroomDao.selectOaApplyOfficeroomByprocInsId(oaApplyOfficeroom);
    }
	/**
	 * 会议室申请
	 */
