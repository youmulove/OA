...
public class OaMsgRecordService extends CrudService<OaMsgRecordDao, OaMsgRecord> {
	...
	public List<OaMsgRecord> findListBycreateUserId(OaMsgRecord oaMsgRecord){
	    return oaMsgRecordDao.findListBycreateUserId(oaMsgRecord);	
	}
	public List<OaMsgRecord> MsgByCreateUserIdGroupByMsgId(OaMsgRecord oaMsgRecord){
		return oaMsgRecordDao.MsgByCreateUserIdGroupByMsgId(oaMsgRecord);
	}
	 public int  CountBycreateUserIdMsgId(OaMsgRecord oaMsgRecord){	 
		return oaMsgRecordDao.CountBycreateUserIdMsgId(oaMsgRecord);
	 }
