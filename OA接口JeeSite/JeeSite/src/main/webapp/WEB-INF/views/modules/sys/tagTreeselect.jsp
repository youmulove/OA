		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"${checked}",nocheckInherit:true},
				...
				data:{simpleData:{enable:true}},callback:{<%--
					...
					onClick:function(event, treeId, treeNode){
						...
						return false;
					},onAsyncSuccess: function(event, treeId, treeNode, msg){//异步加载正常结束的回调函数
											//treeId:ztree的名称，treeNode:树进行异步加载的父节点
					//console.log(treeNode);
						var nodes = tree.getNodesByParam("pId", treeNode.id, null);//在所有树节点中查找pId为treeNode.id的节点
						for (var i=0, l=nodes.length; i<l; i++) {
							//将搜索到的节点按照json中checked的值勾选起来
							//我去掉的try{tree.checkNode(nodes[i], treeNode.checked, true);}catch(e){}
