...
/*function addBookmark() {
		alert("向光标处加入名称为bookmark的书签");
		document.all.WebOffice1.SetFieldValue("mark", "bookmark", "::ADDMARK::");	
		

}
function taohong(){
	alert("给名为test的书签添加套红信息：北京点聚信息技术有限公司");
	document.all.WebOffice1.SetFieldValue("test", "http://127.0.0.1:8888/test.doc", "::FILE::");	
}*/
/****************************************************
*
*					填充模板
