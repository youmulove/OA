...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="office" name="office.id" value="${user.office.id}" labelName="office.name" labelValue="${user.office.name}"
					title="部门" url="/sys/office/treeData?type=2" cssClass="required error input-medium" notAllowSelectParent="false"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="sysrank" name="sysrank.id" value="${user.sysrank.id}" labelName="sysrank.name" labelValue="${user.sysrank.name}"
					title="职级" url="/sys/sysRank/rankData?officeId=${user.company.id}" cssClass="required error input-medium"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">性别:</label>
			<div class="controls">
				<form:select path="mobile" class="input-large">
	...
	<%-- 	<div class="control-group">
		...
		<div class="control-group">
		        <%-- <c:choose>
		        	<c:when test="${fns:getUser().dataScope.contains('4')||fns:getUser().dataScope.contains('5')||fns:getUser().dataScope.contains('8')}">
