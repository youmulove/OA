...
public class ArticleService extends CrudService<ArticleDao, Article> {
	...
	@Transactional(readOnly = false)
	public List<Article> findListByCatrgoryId(String categoryId) {
		List<Article> findListByCatrgoryId = new ArrayList<Article>();
		if (categoryId != null) {
			Article artcile = new Article();
			artcile.setCategory(new Category(categoryId));
			findListByCatrgoryId = articleDao.findListByCatrgoryId(artcile);
		}
		return findListByCatrgoryId;
	}
