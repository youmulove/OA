...
<body>
	...
	<form:form id="inputForm" modelAttribute="leave" action="${ctx}/oa/leave/leaveApplyAgain?taskId=${taskId}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="day" style="width: 20px">&nbsp;天
			</div>
		</div>
		<a href="${pageContext.request.contextPath}/views/modules/oa/approvalProcess.jsp"></a>
		<div class="control-group">
			<label class="control-label">请假原因：</label>
			<div class="controls">
				<form:textarea path="reason" class="required" rows="5" maxlength="20"></form:textarea>
			</div>
		</div>
