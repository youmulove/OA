...
<button class="btn btn-white btn-sm" onclick="readAll()" data-toggle="tooltip" data-placement="top"><i class="fa fa-eye"> ${label==null?'标为已读':label}</i>
                        </button>
	...
	function readAll(){
		...
		// var url = $(this).attr('data-url');
		  ...
		  if(ids == ""){
			...
			top.layer.confirm('确认要标记为已读吗?', {icon: 3, title:'系统提示'}, function(index){
