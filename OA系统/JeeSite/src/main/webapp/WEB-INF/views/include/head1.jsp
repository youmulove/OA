...
<!-- jeeplus -->
<link href="${ctxStatic}/common1/jeeplus.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common1/jeeplus.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/common1/css/style.css?v=3.2.0" type="text/css" rel="stylesheet" />
...
<!-- 引入自定义文件 -->
<script src="${ctxStatic}/common1/mustache.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/common1/content.js" type="text/javascript"></script>
<link href="${ctxStatic}/common1/css/login.css" type="text/css" rel="stylesheet" />
...
<link rel="shortcut icon" href="${ctxStatic}/icon/favicon.ico" type="image/x-icon" />
