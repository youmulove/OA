...
<link href="${ctxStatic}/bootstrap/2.3.1/css_default<%-- ${not empty cookie.theme.value ? cookie.theme.value : 'cerulean'} --%>/bootstrap.min.css" type="text/css" rel="stylesheet" />
...
<script src="${ctxStatic}/echarts-2.2.7/echarts.js"></script>  
 <script src="${ctxStatic}/echarts-2.2.7/TreeGraph.js" type="text/javascript"></script>