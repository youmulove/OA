...
<title>审批流程</title>
<link rel="stylesheet"
	href="${ctxStatic}/approvalProcess/css/global.css" />
<link rel="stylesheet"
	href="${ctxStatic}/approvalProcess/css/approvalProcess.css" />
...
<body>
	<main class="main clearfix" style="width:100%; height:100%;"> <!--<header class="m__header">
      审批流程控制
    </header>-->
	<ul class="nav nav-tabs clearfix">
		<li class="active"><a
			href="/jeesite/a/oa/approvalProcess/returnPage">发起申请</a>
		</li>
		<li><a href="/jeesite/a/act/task/myProcess?type=leave">我发起的</a>
		</li>
	</ul>
	<div style="display:flex">
		<aside class="m__aside j-aside">
			<ul>
				<li data-url="url_leave" class="hover"><img
					src="${ctxStatic}/approvalProcess/img/leave.png" alt="" />请假</li>
				<li data-url="url_overtime"><img
					src="${ctxStatic}/approvalProcess/img/overtime.png" alt="" />加班</li>
				<li data-url="url_home" onclick="officeRoomList2()"><img
					src="${ctxStatic}/approvalProcess/img/home.png" alt="" />会议室</li>
				<li data-url="url_projector" onclick="projectorApproval()"><img
					src="${ctxStatic}/approvalProcess/img/projector.png" alt="" />投影仪</li>
				<li data-url="url_currency" onclick="currencyApproval()"><img
					src="${ctxStatic}/approvalProcess/img/common.png" alt="" />用章</li>
			</ul>
		</aside>
		<article class="m__article">
			...
			<div class="url_leave">
				<div class="m__ar__list">
					<form class="j-validateForm1" action="${ctx}/oa/leave/leaveApply"
                  ...
                  <input readonly class="layDate required error" type="text" name="startendTime"/>
							...
							<li><label class="form--title form--star" for="">开始时间</label>
							...
							<li><label class="form--title form--star" for="">结束时间</label>
							...
							<li><label class="form--title form--star" for="">天数（天）</label>
								<input id="leaveDay" class="required error" type="text"
								name="hours" onblur="leaveApproval()" style="width: 50px" />&nbsp;&nbsp;&nbsp;天
							</li>
							<li id="leaveApproval"><label class="form--title form--star"
								for="">请假事由</label> <textarea class="required error"
									id="leaveReason" name="reason" cols="30" rows="10"></textarea>
							</li>
							<li><label class="form--title control-label">添加抄送人：</label>
								<div class="controls">
									<sys:treeselect id="oaNotifyRecord" name="oaNotifyRecordIds"
										...
										url="/sys/office/treeData?type=3" cssClass="input-xxlarge"
                  ...
                  <input class="form--file" type="file" name="leaveImg"/>
						...
						<input type="submit" <%--onclick="leaveSub()"--%> class="m--btn"
							value="提交">
					</form>
				</div>
			...
			<div class="url_overtime" style="display:none;">
				<div class="m__ar__list">
					<form class="j-validateForm2" id="overTimeApplyForm"
						action="${ctx}/oa/approvalProcess/overTimeApply" method="post">
						<ul>
							<!--<li>默认审批人
                ...
                <li>审批人去重
                  ...
                  <input readonly class="layDate required error" type="text" name="startendTime"/>
							...
							<li><label class="form--title form--star" for="">开始时间</label>
								<input id="startTime2" name="startTime" type="text"
								readonly="readonly" maxlength="20"
								class="input-medium Wdate required "
								value="<fmt:formatDate value="${oaNotifyMeeting.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
							...
							<li><label class="form--title form--star" for="">结束时间</label>
								<input id="endTime2" name="endTime" type="text"
								readonly="readonly" maxlength="20"
								class="input-medium Wdate required "
								value="<fmt:formatDate value="${oaNotifyMeeting.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
							...
							<li><label class="form--title form--star" for="">时长（小时）</label>
								...
								class="required error" placeholder="4" /></li>
							<li id="isholiday"><label class="form--title form--star"
								for="">法定节假日</label> <input type="radio" id="isHoliday"
								name="isHoliday" value="y" />是&nbsp;&nbsp;&nbsp;&nbsp; <input
								type="radio" id="isHoliday" name="isHoliday" value="n" />否</li>
							<li id="approvalPerson"><label
								class="form--title form--star" for="">加班事由</label> <textarea
									id="overTimeReason" name="reason" class="required error"
									cols="30" rows="10"></textarea></li>
							<li><label class="form--title control-label">添加抄送人：</label>
								<div class="controls">
									<sys:treeselect id="fuckOverTime" name="oaNotifyRecordIds"
										value="${oaNotify.oaNotifyRecordIds}"
										labelName="oaNotifyRecordNames"
										labelValue="${oaNotify.oaNotifyRecordNames}" title="用户"
										url="/sys/office/treeData?type=3" cssClass="input-xxlarge"
                  ...
                  <input class="form--file" type="file"/>
						...
						<input type="submit"
							<%--onclick="overTimeSub()"--%> name="overTimeBtn" class="m--btn"
							value="提交">
					</form>
				</div>
			...
			<div class="url_home" style="position:relative; display:none;">
				<div class="m__ar__list home__list">
					...
					<ul id="ul">
						<li class="clearfix"
							style="line-height: normal; margin-bottom:20px;" id="li">
							...
							<div class="home--content" style="height:100%;">
								<p>
									<!-- <span>申请日期</span> -->
									<span style="width: 300px;text-align: center">使用时间</span> <span
										style="width: 150px;text-align: center">部门</span> <span
										style="width: 80px;text-align: center">申请人</span>
								</p>
							</div></li>
						<%-- <li class="clearfix" >
				...
				<!--申请会议室-->
				<button class="j-applyHome m--btn"
					style="position:absolute;top:-25px;right:-75px;" class="m--btn"
					type="button">申请会议室</button>
			</div>
			<!--投影仪部分-->
			<div class="url_projector" style="display:none;">
				<div class="m__ar__list">
					<form class="j-validateForm3" id="projectorApply"
						action="${ctx}/oa/approvalProcess/projectorApply" method="post">
						<ul>
                  ...
                  <input readonly class="required error layDate" type="text" name="startendtime"/>
							...
							<li><label class="form--title form--star" for="">开始时间</label>
								<input id="startTime4" name="startTime" type="text"
								readonly="readonly" maxlength="20"
								class="input-medium Wdate required "
								value="<fmt:formatDate value="${oaNotifyMeeting.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
							...
							<li><label class="form--title form--star" for="">结束时间</label>
								<input id="endTime4" name="endTime" type="text"
								readonly="readonly" maxlength="20"
								class="input-medium Wdate required "
								value="<fmt:formatDate value="${oaNotifyMeeting.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
							...
							<li><label class="form--title form--star" for="">时长（小时）</label>
								<input class="required error" id="proHours" type="text"
								name="hours" /></li>
							<li><label class="form--title form--star" for="">投影仪选择</label>
								<select class="required error" style="width:50%;"
								name="projectoroNo" id="projectorList">
									<option value="">请选择投影仪</option>
							</select></li>
							<li><label class="form--title form--star" for="">是否需要转换头</label>
								<input type="radio" name="adapter" onclick="projectorApproval()"
								checked="checked" value="y" />是&nbsp;&nbsp;&nbsp;&nbsp; <input
								type="radio" name="adapter" onclick="projectorApproval()"
								value="n" />否</li>
							<li id="projectorApproval"><label
								class="form--title form--star" for="">使用事由</label> <textarea
									class="required error" id="proReason" name="reason" cols="30"
									rows="10"></textarea></li>
							<li><label class="form--title control-label">添加抄送人：</label>
								<div class="controls">
									<sys:treeselect id="fuckProjector" name="oaNotifyRecordIds"
										value="${oaNotify.oaNotifyRecordIds}"
										labelName="oaNotifyRecordNames"
										labelValue="${oaNotify.oaNotifyRecordNames}" title="用户"
										url="/sys/office/treeData?type=3" cssClass="input-xxlarge"
                  ...
                  <input class="form--file" type="file"/>
						...
						<input id="overTimeBth" type="submit"
							<%--onclick="sub()" --%> name="overTimeBtn" class="m--btn"
							value="提交">
					</form>
				</div>
				<!-- <button class="m--btn" type="button">提交</button> -->
			...
			<div class="url_currency" style="display:none;">
				<div class="m__ar__list">
					<form class="j-validateForm4" id="currencyApply"
						action="${ctx}/oa/approvalProcess/currencyApply" method="post"
                  ...
                  <input readonly class="layDate required error" type="text" name="startendTime"/>
							...
							<li><label class="form--title form--star" for="">开始时间</label>
								<input id="startTime5" name="startTime" type="text"
								readonly="readonly" maxlength="20"
								class="input-medium Wdate required "
								value="<fmt:formatDate value="${oaNotifyMeeting.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
							...
							<li><label class="form--title form--star" for="">结束时间</label>
								<input id="endTime5" name="endTime" type="text"
								readonly="readonly" maxlength="20"
								class="input-medium Wdate required "
								value="<fmt:formatDate value="${oaNotifyMeeting.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
								onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false,minDate:'#F{$dp.$D(\'startTime5\')}',maxDate:'2120-10-01'});" />
							</li>
							<li><label class="form--title form--star" for="">用章类型</label>
								<select name="selectChapters" style="width: 310px;" id="">
									<option value="公章">公章</option>
									<option value="合同章">合同章</option>
									<option value="人事章">人事章</option>
									<option value="法人章">法人章</option>
									<option value="财务专用章">财务专用章</option>
							</select></li>
							<li><label class="form--title form--star" for="">用章事宜</label>
								<textarea class="required error" id="applyItem" name="applyItem"
									cols="30" rows="3"></textarea></li>
							<li><label class="form--title control-label">盖章文件：</label>
								<div class="controls">
									<input type="hidden" id="nameImage" path="stampFiles"
										htmlEscape="false" maxlength="255" class="input-xlarge"
										name="stampFiles" />
									<sys:ckfinder input="nameImage" type="images"
										uploadPath="/photo" selectMultiple="true" maxWidth="100" maxHeight="100"/>
								</div>
							</li>
							<li><label class="form--title form--star" for="">用章份数</label>
								<input class="required error" type="text" id="chaptersNumber"
								name="chaptersNumber" onkeyup="NumCheck(this)"/></li>
							<li  id="currencyApproval"><label class="form--title form--star" for="">内容</label>
								<textarea class="required error" id="currencyReason"
									name="reason" cols="30" rows="3"></textarea></li>
							<li><label class="form--title control-label">添加抄送人：</label>
								<div class="controls">
									<sys:treeselect id="fuckCurrency" name="oaNotifyRecordIds"
										value="${oaNotify.oaNotifyRecordIds}"
										labelName="oaNotifyRecordNames"
										labelValue="${oaNotify.oaNotifyRecordNames}" title="用户"
										url="/sys/office/treeData?type=3" cssClass="input-xxlarge"
                  ...
                  <input class="form--file" type="file"/>
						...
						<!-- <input type="submit"  name="overTimeBtn" class="m--btn" value="提交"> -->
						<input type="submit"
							<%--onclick="currencySub()"--%> name="overTimeBtn" class="m--btn"
							value="提交">
					</form>
					<%-- </form:form> --%>
				</div>
