            ...
            <div class="col-sm-10 animated fadeInRight">
                <div class="mail-box-header">
                    ...
                    <div class="mail-tools tooltip-demo m-t-md">
                       ...
                       <%--   <table:readRow url="${ctx}/iim/mailBox/readAll" id="contentTable"></table:readRow><!-- 已读按钮 -->
                    ...
                    <table id="contentTable" class="table table-hover table-mail">
                    	<thead> 
                    		<tr>
                    			...
                    			<th  class="sort-column receiver.name">发件人</th>
                        ...
                        <tbody>
                        	...
                        	<c:forEach items="${page.list}" var="mailCompose">
								<tr>
									<td class="check-mail">
	                                    <input id="${mailCompose.mail.id}" type="checkbox" class="i-checks">
	                                </td>
	                                <td class=""><a href="${ctx}/iim/mailCompose/draftDetail?id=${mailCompose.mail.id}">
                                	${mailCompose.sender.name}
									</a></td>
                                	<td class="mail-ontact"><a href="${ctx}/iim/mailCompose/draftDetail?id=${mailCompose.mail.id}">
                                		
										${mailCompose.mail.title}
									</a></td>
									<td class="mail-subject"><a href="${ctx}/iim/mailCompose/draftDetail?id=${mailCompose.mail.id}">
									...
									<td>
										<a href="${ctx}/iim/mailCompose/delete1?id=${mailCompose.mail.id}" onclick="return confirmx('确认要删除该站内信吗？', this.href)"   class="btn btn-info btn-xs btn-danger"><i class="fa fa-trash"></i> 删除</a>
									</td>
								</tr>
							</c:forEach>
