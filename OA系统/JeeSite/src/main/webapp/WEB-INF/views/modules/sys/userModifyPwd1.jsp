...
<body>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/modifyPwd1" method="post" class="form-horizontal" style="margin-top:15px;">
		<form:hidden path="id"/>
		...
		<div class="form-actions" style="background-color:#fff;border-top:none;text-align:center;padding-left:0;">
