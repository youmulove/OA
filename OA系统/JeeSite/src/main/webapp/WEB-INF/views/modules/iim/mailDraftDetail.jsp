                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content mailbox-content">
                        <div class="file-manager">
                            <a class="btn btn-block btn-info compose-mail" href="${ctx}/iim/mailCompose/sendLetter">写信</a>
                ...
                <div class="mail-box-header">
                    <div class="pull-right tooltip-demo">
                       <button type="button" class="btn btn-white  btn-sm" onclick="saveLetter()"> <i class="fa fa-pencil"></i> 存为草稿</button>
                        <a href="${ctx}/iim/mailCompose/list?status=0&orderBy=sendtime desc" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="放弃"><i class="fa fa-times"></i> 放弃</a>
                    </div>
                    <h2>
                    写信
                </h2>
                ...
                <div class="mail-box">
					...
					<form:form id="inputForm" modelAttribute="mailCompose" action="${ctx}/iim/mailCompose/save" method="post" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
			               		 <sys:treeselect id="receiver" name="receiverIds" value="${mailCompose.ids}" labelName="receiverNames" labelValue="${mailCompose.receivers}"
                          ...
                          <input type="hidden" id="id" name="mailId" value="${mailCompose.mail.id}"><!-- id -->
                    ...
                    <div class="mail-body text-right tooltip-demo">
                        ...
                        <a href="${ctx}/iim/mailCompose/list?status=0&orderBy=sendtime desc" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Discard email"><i class="fa fa-times"></i> 放弃</a>
                   		 <button type="button" class="btn btn-white  btn-sm" onclick="saveLetter()"> <i class="fa fa-pencil"></i> 存为草稿</button>
                    </div>
                    <div class="clearfix"></div>
 ...
 <div style="display:none" id="contentView">
   ...
   ${mailCompose.mail.content}
    ...
    <script>
	    ...
	    $("#receiverId").closest(".input-append").css("width","100%").addClass("clearfix");
    </script>
