            ...
            <div class="col-sm-10 animated fadeInRight">
                <div class="mail-box-header">
                    ...
                    <h5>
                        ...
                        <span class="font-noraml">发件人： </span>${(fns:getUserById(mailCompose.sender.id)).name}
                    </h5>
                    <h5>
                        <span class="font-noraml">收件人： </span>${mailCompose.receivers}
                        <%-- ${(fns:getUserById(mailCompose.receiver.id)).name} --%>
                    </h5>
                    </div>
                </div>
                <div class="mail-box">
