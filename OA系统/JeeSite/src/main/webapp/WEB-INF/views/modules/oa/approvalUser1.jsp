			...
			<div class="form-list">
				...
				<div class="form--input">
					<c:if test="${ not empty list[startIndex-i.index].approvalPerson}">
						<input class="required error" style="width:220px;" type="text"
							name="app" readonly="readonly"
							value="${list[startIndex-i.index].approvalPerson}"
							placeholder="4" />
						<input class="" style="width:220px;" type="hidden" name="app1"
							readonly="readonly" value="${list[0].approvalYuliu5}"
							placeholder="4" />
		...
		<div class="form-list">
			...
			<div class="form--input">
				<sys:treeselect id="freePerson1" name="freePerson1"
					...
					url="/sys/office/treeData?type=3" cssClass="input-xxlarge required c-inputStyle"
					notAllowSelectParent="true" allowClear="true" cssStyle="width:100%;"/>
			</div>
		</div>
		<div class="form-list">
			...
			<div class="form--input">
				<sys:treeselect id="freePerson2" name="freePerson2"
					...
					url="/sys/office/treeData?type=3" cssClass="input-xxlarge  c-inputStyle"
					notAllowSelectParent="true" allowClear="true" cssStyle="width:100%;"/>
			</div>
		</div>
		<div class="form-list">
