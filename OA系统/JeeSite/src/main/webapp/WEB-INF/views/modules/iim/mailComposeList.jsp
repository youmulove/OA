                        ...
                        <tbody>
                        	...
                        	<c:forEach items="${page.list}" var="mailCompose">
								<tr>
	                                ...
	                                <td class=""><a href="${ctx}/iim/mailCompose/detail?id=${mailCompose.mail.id}">
                                		${mailCompose.sender.name}
									</a></td>
                                	<td class="mail-ontact"><a href="${ctx}/iim/mailCompose/detail?id=${mailCompose.mail.id}">
                                		
										${mailCompose.mail.title}
									</a></td>
									<td class="mail-subject"><a href="${ctx}/iim/mailCompose/detail?id=${mailCompose.mail.id}">
									...
									<td>
										<a href="${ctx}/iim/mailCompose/delete?id=${mailCompose.mail.id}" onclick="return confirmx('确认要删除该站内信吗？', this.href)"   class="btn btn-info btn-xs btn-danger"><i class="fa fa-trash"></i> 删除</a>
									</td>
								</tr>
							</c:forEach>
