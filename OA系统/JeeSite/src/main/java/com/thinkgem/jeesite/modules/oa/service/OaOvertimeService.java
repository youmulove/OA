			...
			if (firId == null && secId == null && thrId == null
				...
				if (firId != null && secId == null && thrId == null
					...
					if (firState != null && secState != null) {
						...
						overtime.setAuditFirState("无");
						overtime.setAuditSecState(("y".equals(secState)) ? "通过"
								: "未通过");
						overtime.setEndAuditState(("y".equals(secState)) ? "通过"
								: "驳回");
					}
					...
					if (firState != null && secState != null
						...
						overtime.setEndAuditState("待审核");
							...
							&& thrState != null) {
						overtime.setAuditFirState("无");
						overtime.setAuditSecState("无");
						overtime.setAuditThrState("y".equals(thrState) ? "通过"
								: "未通过");
						overtime.setEndAuditState(("y".equals(thrState)) ? "通过"
								: "驳回");
					} else if (firState == null && secState != null
							&& thrState != null) {
						overtime.setAuditFirState("无");
					...
					if (firState != null && secState != null
						...
						overtime.setAuditFirState(firState == "y" ? "通过"
								: "未通过");
						overtime.setEndAuditState(firState == "y" ? "待审核"
								: "驳回");
					} else if (firState != null && secState != null
							&& thrState == null && fouState == null) {
						overtime.setAuditFirState("通过");
						overtime.setAuditSecState(secState == "y" ? "通过"
								: "未通过");
						overtime.setEndAuditState(secState == "y" ? "待审核"
								: "驳回");
					} else if (firState != null && secState != null
							&& thrState != null && fouState == null) {
						overtime.setAuditFirState("通过");
						...
						overtime.setAuditThrState(thrState == "y" ? "通过"
								: "未通过");
						overtime.setEndAuditState(thrState == "y" ? "待审核"
								: "驳回");
					} else if (firState == null && secState == null
							&& thrState == null && fouState != null) {
						overtime.setAuditFirState("无");
						overtime.setAuditSecState("无");
						overtime.setAuditThrState("无");
						overtime.setAuditFouState(fouState == "y" ? "通过"
								: "未通过");
						overtime.setEndAuditState(fouState == "y" ? "待审核"
								: "驳回");
					} else if (firState == null && secState == null
							&& thrState != null && fouState == null) {
						overtime.setAuditFirState("无");
		...
		if (fourPerson == null || "".equals(fourPerson)) {
			if (threePerson == null || "".equals(threePerson)) {
				...
				if (threeFlag != null && !("".equals(threeFlag))) {
					if (twoFlag.equals("y") && threeFlag.equals("y")) {
						return "y";
					} else {
						return "n";
					}
