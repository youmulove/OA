...
public class FormAuthenticationFilter extends
	...
	/*
	 * public String getUsertype(ServletRequest request) { return
	 * WebUtils.getCleanParam(request, getUsertypeParam()); }
	 * 
	 * public String getUsertypeParam() { return usertypeParam; }
	 */
