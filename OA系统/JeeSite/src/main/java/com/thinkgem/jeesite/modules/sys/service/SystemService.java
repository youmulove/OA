...
public class SystemService extends BaseService implements InitializingBean {
	...
	public List<SysRank> findsysRankByOfficeId(String officeId) {
		 ...
		 * UserUtils.SYSRANK_CACHE, UserUtils.SYSRANK_CACHE_LIST_BY_COMPANY_ID_
		 * + officeId); if (list == null) {
		 */
		List<SysRank> list = new ArrayList<SysRank>();
		 ...
		 * UserUtils.SYSRANK_CACHE_LIST_BY_COMPANY_ID_ + officeId, list);
		 * 
		 * }
		 */
		return list;
