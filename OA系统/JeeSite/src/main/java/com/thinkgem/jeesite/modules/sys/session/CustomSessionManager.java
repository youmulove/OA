...
import com.thinkgem.jeesite.modules.sys.dao.CustomShiroSessionDAO;
...
public class CustomSessionManager {
	...
	JedisSessionDAO jedisSessionDAO;
	...
	public List<UserOnlineBo> getAllUser() {
		// 获取所有session
		Collection<Session> sessions = jedisSessionDAO
				.getActiveSessions();
	...
	public Map<String, Object> changeSessionStatus(Boolean status,
		...
		try {
			...
			for (String id : sessionIdArray) {
				...
				jedisSessionDAO.update(session);
			}
			map.put("status", 200);
	...
	public void setjedisSessionDAO(
			JedisSessionDAO jedisSessionDAO) {
		this.jedisSessionDAO = jedisSessionDAO;
	}
}
