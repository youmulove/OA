...
public class RoleController extends BaseController {
	...
	public String form(Role role, Model model) {
		/*
		 * if (role.getOffice() == null && !role.getId().equals('1')) {
		 * role.setOffice(UserUtils.getUser().getOffice()); } if
		 * (role.getOffice() == null && role.getId().equals('1')) {
		 * role.setOffice(null); }
		 */
	...
	public String assign(Role role, Model model) {
		List<User> userList = systemService.userList(new User(new Role(role
				.getId())));
