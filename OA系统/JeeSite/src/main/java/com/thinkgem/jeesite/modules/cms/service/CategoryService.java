...
public class CategoryService extends TreeService<CategoryDao, Category> {
	...
	@Transactional(readOnly = false)
	public List<Category> delteteAllArticles(Category category) {
		List<Category> delteteAllArticles = new ArrayList<Category>();
		if (category != null) {
			delteteAllArticles = categoryDao.delteteAllArticles(category);
		}
		return delteteAllArticles;
	}
