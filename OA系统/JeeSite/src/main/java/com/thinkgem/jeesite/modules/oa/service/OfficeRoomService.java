...
public class OfficeRoomService extends CrudService<OfficeRoomDao, OfficeRoom> {
	...
	public List<OfficeRoom> findAll() {
		...
		return officeRoomDao.findAllList(officeRoom);
	}
	...
	public void officeRoomApply(OaApplyOfficeroom officeRoom,
		...
		if (appList.get(0).getApprovalProcess().equals("0")) {
			if (freePerson1 != null && !freePerson1.equals("")) {
				str1 = freePerson1;
				officeRoom.setAuditFirId(freePerson1);
				processDefinitionKey = "1";
			}
			if (freePerson2 != null && !freePerson2.equals("")) {
				str2 = freePerson2;
				officeRoom.setAuditSecId(freePerson2);
				processDefinitionKey = "2";
			}
			if (freePerson3 != null && !freePerson3.equals("")) {
				str3 = freePerson3;
				officeRoom.setAuditThrId(freePerson3);
				processDefinitionKey = "3";
			}

			if (freePerson4 != null && !freePerson4.equals("")) {
				str4 = freePerson4;
				officeRoom.setAuditFouId(freePerson4);
