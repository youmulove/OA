...
public class MailComposeService extends
		CrudService<MailComposeDao, MailCompose> {
	@Autowired
	...
	public List<MailCompose> get2(String mailId) {
		return mailComposeDao.get2(mailId);
	}

	public List<MailCompose> get3(String mailId) {
		return mailComposeDao.get3(mailId);
	}
	...
	public Page<MailCompose> findPage(MailPage<MailCompose> page,
