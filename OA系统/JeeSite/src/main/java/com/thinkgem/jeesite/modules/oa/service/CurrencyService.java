...
public class CurrencyService extends BaseService {
	...
	public void currencyApply(OaApply currency, String oaNotifyRecordIds,
		...
		variables.put("currency", currency); // 类型为用章类型
		...
		variables.put("title", user.getName() + "的用章申请");
